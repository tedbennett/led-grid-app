...
//                UserOrb(user: UserManager.shared.getUser(id: id), isSelected: false)
//                    .frame(width: 26, height: 26)
//                    .padding(0)
//            }
//            if item.receivers.count > 3 {
//                InitialsOrbView(text: "+\(item.receivers.count - 2)", isSelected: false).frame(width: 26, height: 26)
//            }
//        }
//    }
//    
...
//                        ForEach(artViewModel.sentArt.filter({ !$0.hidden })) { item in
...
//                                        ) {
//                                            withAnimation {
//                                                artViewModel.toggleHideSentArt(id: item.id)
//                                            }
//                                        }
//                                    }
//                                    .drawingGroup()
