...
//
//    var model: ArtModel
//    @Published var art: [String: [MPixelArt]] = [:]
...
//    }
//
//    private func emptyMap() -> [String: [MPixelArt]] {
//        var map: [String: [MPixelArt]] = [:]
...
//
//        let mappedGrids: [String: [MPixelArt]] = grids.reduce(into: emptyMap()) { map, grid in
...
//    }
//
//    func addSentArt(_ art: MPixelArt) async {
